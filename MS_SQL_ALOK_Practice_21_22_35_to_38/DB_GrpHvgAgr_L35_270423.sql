create database DB_GrpHvgAgr_L35_270423
use DB_GrpHvgAgr_L35_270423
-- Lecture 35  -- yahan se padhna hai
...
group by gender-- genderwise salary sum
...
select department as EmpDepartment  , count(*)  From EMployee group by department
